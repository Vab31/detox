...
export default function Whatyouwill() {
  return (
    <div
      id="main"
      className="border border-gray-300 shadow-md p-4 md:mx-28 md:mb-16"
    >
      ...
      <div class="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
        <div class="p-2 w-full">
          <div class=" bg-gray-600 rounded flex p-4 h-full items-center">
            ...
            <span class="title-font text-white font-bold text-xl md:text-2xl ">
              Identify Top 5 Mistakes causing your body pains.
            </span>
          </div>
        </div>
        <div class="p-2 sm:w-1/ w-full">
          <div class="bg-gray-600 rounded flex p-4 h-full items-center">
            ...
            <span class="title-font  text-white font-bold text-xl md:text-2xl ">
              Use my 5 min Monkey Mind Calming Strategy.
            </span>
          </div>
        </div>
        <div class="p-2 sm:w-1/ w-full">
          <div class="bg-gray-600 rounded flex p-4 h-full items-center">
            ...
            <span class="title-font  text-white font-bold text-xl md:text-2xl ">
              Learn to my favourite technique to energise with your organs
              daily.
            </span>
          </div>
        </div>
        <div class="p-2 sm:w-1/ w-full">
          <div class="bg-gray-600 rounded flex p-4 h-full items-center">
            ...
            <span class="title-font  text-white font-bold text-xl md:text-2xl ">
              Create 3 new habits to prevent future diseases.
            </span>
          </div>
        </div>
        <div class="p-2 sm:w-1/ w-full">
          <div class="bg-gray-600 rounded flex p-4 h-full items-center">
            ...
            <span class="title-font  text-white font-bold text-xl md:text-2xl ">
              Earn money helping others heal naturally.
            </span>
          </div>
        </div>
      </div>
